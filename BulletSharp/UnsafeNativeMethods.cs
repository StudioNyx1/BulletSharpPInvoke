...
namespace BulletSharp
{
	...
	internal static class UnsafeNativeMethods
	{
		...
		[DllImport(Native.Dll, CallingConvention = Native.Conv)]
		public static extern double btSoftBody_Node_getSplineEval(IntPtr obj);
		[DllImport(Native.Dll, CallingConvention = Native.Conv)]
		...
		[DllImport(Native.Dll, CallingConvention = Native.Conv)]
		public static extern void btCable_getLocalAnchorWithNode(IntPtr cable, int indexNode, out Vector3 local);
        ...
        [DllImport(Native.Dll, CallingConvention = Native.Conv)]
        public static extern void btCable_AnchorPlacement_SetActive(IntPtr obj, bool active);
		...
		[DllImport(Native.Dll, CallingConvention = Native.Conv)]
		public static extern void btCable_setCollisionParameters(IntPtr obj, int substepDelaySolver, int substeDelayNarrow);
