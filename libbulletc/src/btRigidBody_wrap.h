...
extern "C" {
	...
	EXPORT void btRigidBody_updateMassAtImpact(btRigidBody* obj, bool canChangedMassAtImpact, btScalar lowerMass, btScalar upperMass, btScalar lowerLimit, btScalar upperLimit);
